...
export default function SubjectContent({ getLoading, getData }: { getLoading: boolean, getData: Subject }) {
  ...
  return (
    <section className="relative flex-1 w-2/3">
      <div className="max-w-5xl mt-16 mx-auto">
        {getLoading
          ...
          <>
            {getData
              ...
              :
              <div className='mx-auto text-left max-w-2xl'>
                <div className='h3 font-bold text-black mb-8'>Cannot Find Subject</div>
              </div>
            }
          </>
        ...
        {getData
          ...
          <div className='mb-16 flex justify-between mx-16'>
            <Link className='inline-flex justify-between p-4 rounded-md text-unimelbScienceBlue border-2 border-unimelbScienceBlue' href={`https://handbook.unimelb.edu.au/2024/subjects/${getData.subjectCode}`} target="_blank" rel="noopener">
            ...
            <Link className='inline-flex justify-between p-4 rounded-md text-unimelbScienceBlue border-2 border-unimelbScienceBlue' href={`https://handbook.unimelb.edu.au/2024/subjects/${getData.subjectCode}/assessment`} target="_blank" rel="noopener">
              <span>
                Next: Assessment
              </span>
